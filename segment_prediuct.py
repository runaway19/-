...
class InferenceConfig:
    ...
    input_image_dir = "C:/Users/ASUS/Desktop/PythonProject/data"

    # 2. 结果输出文件夹路径 (程序会自动创建)
    output_dir = "C:/Users/ASUS/Desktop/PythonProject/reslut"

    # 3. 训练好的模型权重路径 (.pth文件)
    model_path = "C:/Users/ASUS/Desktop/PythonProject/final_model_20260102_140556.pth"
